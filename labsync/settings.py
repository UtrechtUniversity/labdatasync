...
ID_D = {
    'DESKTOP-JPOERNQ':'DELL06', #EEG 042, win 10
    'DESKTOP-N929EH5':'DELL05', #EEG 041, win 10
    'CID_':'DELL03',#Mock 024 MRI, win7,
    'KKC':'DELL02',#PCI 046, win7
    'Mac08':'MAC08',#computer tasks
    'Mac06':'MAC06',#ET 043
    'Mac02':'MAC02',#ET 044
    'Mac05':'MAC05',#EEG 042, EEG data will be synced from connected DELL
    'Mac04':'MAC04',#EEG 041, EEG data will be synced from connected DELL
    'wolk':'MAC07',
    'LAPTOP-L8GS0BAG':'LENOVO01',#testing repos on win on presentation computer
    'Mac-mini-van-Testteam':'MAC11',#test device testteam (Pooya Nikdel)
    'PN':'HP01'}
